			   ...
			   struct proto *prot, int proto, gfp_t prio, int kern)
{
	...
	if (!kern) {
#if LINUX_VERSION_IS_GEQ(5,14,10) || LINUX_VERSION_IN_RANGE(5,10,71, 5,11,0) || LINUX_VERSION_IN_RANGE(5,4,151, 5,5,0) || LINUX_VERSION_IN_RANGE(4,19,209, 4,20,0) || LINUX_VERSION_IN_RANGE(4,14,249, 4,15,0) || LINUX_VERSION_IN_RANGE(4,9,286, 4,10,0) || LINUX_VERSION_IN_RANGE(4,4,288, 4,5,0)
