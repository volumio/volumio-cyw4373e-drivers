...
static int backport_qrtr_sendmsg(struct kiocb *iocb, struct socket *sock,
...
#if LINUX_VERSION_IS_LESS(4,1,0)
static int backport_qrtr_recvmsg(struct kiocb *iocb, struct socket *sock,
				 struct msghdr *msg, size_t len, int flags){
	return qrtr_recvmsg(sock, msg, len, flags);
}
#endif /* LINUX_VERSION_IS_LESS(4,1,0) */
...
#else
	.sendmsg = backport_qrtr_sendmsg,
#endif /* LINUX_VERSION_IS_GEQ(4,1,0) */
	
#if LINUX_VERSION_IS_GEQ(4,1,0)
	.recvmsg	= qrtr_recvmsg,
#else
	.recvmsg = backport_qrtr_recvmsg,
#endif /* LINUX_VERSION_IS_GEQ(4,1,0) */
