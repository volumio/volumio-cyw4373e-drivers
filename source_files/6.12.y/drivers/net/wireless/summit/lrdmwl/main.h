...
void mwl_mac80211_remove_vif(struct mwl_priv *priv, struct ieee80211_vif *vif);
int mwl_mac80211_sta_remove(struct ieee80211_hw *hw, struct ieee80211_vif *vif, struct ieee80211_sta *sta);
