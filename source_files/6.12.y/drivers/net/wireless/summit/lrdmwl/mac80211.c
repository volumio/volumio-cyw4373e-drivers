...
void mwl_mac80211_stop(struct ieee80211_hw *hw, bool suspend)
{
	struct mwl_priv *priv = hw->priv;
...
static void mwl_mac80211_sta_rc_update(struct ieee80211_hw *hw,
			      struct ieee80211_vif *vif,
			      struct ieee80211_sta *sta,
			      u32 changed)
{
					  ...
					  u64 changed)
{
	...
	if ((changed & BSS_CHANGED_ASSOC) && vif->cfg.assoc) {
		if (vif->type == NL80211_IFTYPE_STATION || vif->type == NL80211_IFTYPE_P2P_CLIENT || vif->type == NL80211_IFTYPE_P2P_DEVICE)
...
static int mwl_mac80211_set_ant(struct ieee80211_hw *hw,
...
static int mwl_mac80211_get_ant(struct ieee80211_hw *hw, u32 *tx_ant,
	u32 *rx_ant)
{
	struct mwl_priv *priv = hw->priv;
...
#ifdef CONFIG_PM
static int mwl_mac80211_suspend(struct ieee80211_hw *hw,
...
static int mwl_mac80211_resume(struct ieee80211_hw *hw)
{
	struct mwl_priv *priv = hw->priv;
...
static void mwl_mac80211_set_wakeup(struct ieee80211_hw *hw, bool enabled)
{
	struct mwl_priv *priv = hw->priv;
...
static void mwl_mac80211_reconfig_complete(struct ieee80211_hw *hw,
...
static void mwl_mac80211_flush(struct ieee80211_hw *hw, 
...
struct ieee80211_ops mwl_mac80211_ops = {
	.tx                         = mwl_mac80211_tx,
