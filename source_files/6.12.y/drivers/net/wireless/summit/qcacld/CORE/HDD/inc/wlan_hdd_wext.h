...
#ifndef CPTCFG_WIRELESS_EXT

static inline
void qcacld_wireless_send_event(struct net_device *dev, unsigned int cmd,
			 union iwreq_data *wrqu, const char *extra)
{}
#define wireless_send_event qcacld_wireless_send_event

static inline
char *qcacld_iwe_stream_add_event(struct iw_request_info *info, char *stream,
			   char *ends, struct iw_event *iwe, int event_len)
{
   return NULL;
}
#define iwe_stream_add_event qcacld_iwe_stream_add_event

static inline
char *qcacld_iwe_stream_add_point(struct iw_request_info *info, char *stream,
			   char *ends, struct iw_event *iwe, char *extra)
{
   return NULL;
}
#define iwe_stream_add_point qcacld_iwe_stream_add_point

static inline
char *qcacld_iwe_stream_add_value(struct iw_request_info *info, char *event,
			   char *value, char *ends, struct iw_event *iwe,
			   int event_len)
{
   return NULL;
}
#define iwe_stream_add_value qcacld_iwe_stream_add_value
#endif
