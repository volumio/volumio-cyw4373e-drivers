...
static void bp_wlan_drv_ops_hdd_tx_timeout(struct net_device *dev){
      hdd_tx_timeout(dev, 0);
}
#endif
...
#else
      .ndo_tx_timeout = bp_wlan_drv_ops_hdd_tx_timeout,
#endif
...
#if defined(WLAN_NS_OFFLOAD) && IS_ENABLED(CONFIG_IPV6)
/**
