...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4,7,0)) || defined(WITH_BACKPORTS)
/**
...
#if  defined(QCA_WIFI_FTM)     && defined(CPTCFG_NL80211_TESTMODE)
...
(LINUX_VERSION_CODE >= KERNEL_VERSION(4, 2, 0)) || defined(WITH_BACKPORTS)
