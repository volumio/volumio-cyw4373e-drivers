...
static void bp_qtnf_netdev_ops_qtnf_netdev_tx_timeout(struct net_device *dev){
...
#else
	.ndo_tx_timeout = bp_qtnf_netdev_ops_qtnf_netdev_tx_timeout,
#endif
...
#if LINUX_VERSION_IS_GEQ(6,6,4) || LINUX_VERSION_IN_RANGE(6,1,120, 6,2,0)
