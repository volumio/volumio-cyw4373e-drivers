...
#ifndef __BACKPORTS_LINUX_RHASHTABLE_H
#define __BACKPORTS_LINUX_RHASHTABLE_H
...
#define rhashtable_init_noprof LINUX_BACKPORT(rhashtable_init_noprof)
#define rhltable_init_noprof LINUX_BACKPORT(rhltable_init_noprof)
