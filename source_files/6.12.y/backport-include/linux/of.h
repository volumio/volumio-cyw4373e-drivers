...
#define of_property_read_u16_array LINUX_BACKPORT(of_property_read_u16_array)
#define of_property_read_u8 LINUX_BACKPORT(of_property_read_u8)
#define of_property_read_u16 LINUX_BACKPORT(of_property_read_u16)
...
static inline bool of_property_read_bool(const struct device_node *np,
					 const char *propname)
{
	return !!of_find_property(np, propname, NULL);
}
#endif
...
#define of_property_present LINUX_BACKPORT(of_property_present)
static inline bool of_property_present(const struct device_node *np, const char *propname)
{
	...
	!LINUX_VERSION_IN_RANGE(6,6,49, 6,7,0) && \
	!LINUX_VERSION_IN_RANGE(6,1,108, 6,2,0)
