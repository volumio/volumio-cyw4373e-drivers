...
static inline int backport_kernel_getsockname(struct socket *sock, struct sockaddr *addr)
{
	int len;
	return kernel_getsockname(sock, addr, &len);
}
#define kernel_getsockname LINUX_BACKPORT(kernel_getsockname)
#endif
