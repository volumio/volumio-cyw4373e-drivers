...
#include <linux/limits.h>
    ...
    LINUX_VERSION_IN_RANGE(4,4,268, 4,5,0) || \
    LINUX_VERSION_IN_RANGE(4,9,235, 4,10,0) || \
    LINUX_VERSION_IN_RANGE(4,14,196, 4,15,0)
...
#define check_shl_overflow(a, s, d) ({					\
	...
	*_d = (_a_full << _to_shift);					\
    ...
    !LINUX_VERSION_IN_RANGE(5,15,88, 5,16,0) && \
    !LINUX_VERSION_IN_RANGE(5,10,201, 5,11,0)
 ...
 */
#define size_mul LINUX_BACKPORT(size_mul)
 ...
 * lvalue must be size_t to avoid implicit type conversion.
 */
#define size_add LINUX_BACKPORT(size_add)
