...
static inline u32 prandom_u32_max(u32 ep_ro)
{
    ...
    !LINUX_VERSION_IN_RANGE(4,9,320, 4,10,0)
...
#define get_random_u16 LINUX_BACKPORT(get_random_u16)
static inline u16 get_random_u16(void)
{
	return get_random_u32() & 0xffff;
}

#define get_random_u8 LINUX_BACKPORT(get_random_u8)
...
#define get_random_u32_inclusive LINUX_BACKPORT(get_random_u32_inclusive)
static inline u32 get_random_u32_inclusive(u32 floor, u32 ceil)
{
	return floor + prandom_u32_max(ceil - floor);
}
#endif
